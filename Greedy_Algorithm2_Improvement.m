...
%运行指令：[Work_Arrangement,Worker_Addition,Work_Arrangement_Improvement,Worker_Addition_Improvement]=Greedy_Algorithm2_Improvement();
...
Average=zeros(1,30); %初始化Average矩阵用于保存平均值
Worker_new=zeros(1,200); %初始化Worker_new用于保存新的工人工作量
Addition_new=zeros(1,200); %初始化Addition_new用于保存新的增加量
Work=Work_bak*100; %
